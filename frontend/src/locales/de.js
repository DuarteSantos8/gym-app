...
export default {
  ...
  // --- body weight & goal ---
  'Quick check-in ⚖️': 'Kurzer Check-in ⚖️',
  ...
  'Tip: tap 🔗 on an exercise to superset it with the one above — you’ll do them back-to-back.': 'Tipp: Tippe bei einer Übung auf 🔗, um sie mit der darüber zum Supersatz zu verbinden — du machst sie direkt nacheinander.',
