...
export default {
  ...
  'Quick check-in ⚖️': 'Быстрое взвешивание ⚖️',
  ...
  'Tip: tap 🔗 on an exercise to superset it with the one above — you’ll do them back-to-back.': 'Совет: нажми 🔗 у упражнения, чтобы объединить его в суперсет с тем, что выше — будешь делать их подряд.',
